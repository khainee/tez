...
#     api_id=api_id,
#     api_hash=api_hash,
#     bot_token=5865175027:AAHLrgozMsIxvXKv8TSDG1yAeL1RMw5rmIE)

bot = Client(
    "bot",
    bot_token=os.environ.get("BOT_TOKEN", "5865175027:AAHLrgozMsIxvXKv8TSDG1yAeL1RMw5rmIE"),
    api_id=int(os.environ.get("API_ID", 18748626)),
    api_hash=os.environ.get("API_HASH", "3c0ef7e51ef52305a17179019575ccc9")
)
